...
func (_m *ReceptionService) CloseLastReception(ctx context.Context, pvzID uuid.UUID) (*reception.Reception, error) {
...
func (_m *ReceptionService) CreateReception(ctx context.Context, pvzID uuid.UUID) (*reception.Reception, error) {
	ret := _m.Called(ctx, pvzID)
